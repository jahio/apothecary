class CreateInventories < ActiveRecord::Migration[8.0]
  def change
    create_table :inventories, id: :uuid do |t|
      t.references :drug, foreign_key: true, type: :uuid, index: true, null: false
      t.references :pharmacy, foreign_key: true, type: :uuid, index: true, null: false
      ...
      t.bigint     :physical_qty, index: true, null: false, default: 0
      ...
      t.bigint     :qty_reserved, index: true, null: false, default: 0
      ...
      t.float      :price_per_unit, index: true, null: false, default: 1.0
